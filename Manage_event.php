        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><?php echo $rows['Ldate'];?></td>
                <td><a href="editplayer.php?id=<?php echo $rows['E_id'];?>"><ion-icon name="create-sharp"></ion-icon> </a>
                <a href="Delete_event.php?id=<?php echo $rows['E_id'];?>" onclick="return confirm('Want to delete this event??'); "><ion-icon name="trash-sharp"></ion-icon> </a>
                </td>
            </tr>
       <?php } ?>
                                </table>
...
<!-- ./wrapper -->
 <a href="Event.php"><button type="button" class="btn btn-block btn-primary btn-lg" style="height:40px;width:150px">Add Event</button></a>
<!-- jQuery -->
