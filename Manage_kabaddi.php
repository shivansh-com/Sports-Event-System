...
$sql = "SELECT * FROM kabaddi ORDER BY K_id DESC ";
        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><i class="glyphicon glyphicon-file"></i><a href="edit_kabaddi.php?id=<?php echo $rows['K_id']; ?>"><ion-icon name="create-sharp"></ion-icon></a>
                <a href="Delete_kabaddi.php?id=<?php echo $rows['K_id']; ?>" onclick="return confirm('Want to delete this team??'); "><ion-icon name="trash-sharp"></ion-icon></a></td>
            </tr>
            <?php
                }
             ?>
...
<!-- ./wrapper -->
<a href="Kabaddi.php"><button type="button" class="btn btn-block btn-primary btn-lg" style="height:40px;width:150px">Add Team</button></a>
<!-- jQuery -->
