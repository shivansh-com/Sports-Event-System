              ...
              <form action="<?php $_PHP_SELF ?>" method="post">
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="T_name" id="T_name"placeholder="Enter Your Team Name" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEid1">Email Id</label>
                    <input type="text" class="form-control" name="Eid" id="Eid" placeholder="Enter Your Email ID" required>
                  </div>
                <!-- /.button -->
...
if(isset($_POST['insert1']))
{
 ...
 $T_name = $_POST['T_name'];
 $Eid = $_POST['Eid'];
 $insert = "INSERT INTO `team`(`T_name`, `Eid`) VALUES ('$T_name','$Eid')";
