...
<?php
 ...
 {
 $G_Id = $_GET['id'];
 $sql = "SELECT * FROM game_type WHERE G_Id ='" . $_GET["id"] . "'";
              ...
              <form action="<?php $_PHP_SELF ?>" method="post">
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Gtype" id="Gtype" value="<?php echo $Gtype;?>"placeholder="<?php echo $Gtype;?>" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputGName1">Game Name</label>
                    <input type="text" class="form-control" name="Gname" id="Gname" value="<?php echo $Gname;?>"placeholder="<?php echo $Gname;?>" required>
                  </div>
...
if(isset($_POST['insert1']))
{
 ...
 $insert = "UPDATE `game_type` SET `Gtype`='$Gtype' ,`Gname`='$Gname' WHERE `G_Id` ='" . $_GET["id"] . "'";
