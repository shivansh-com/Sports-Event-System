...
<?php
 ...
 {
 $K_id = $_GET['id'];
 $sql = "SELECT * FROM kabaddi WHERE K_id ='" . $_GET["id"] . "'";
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Kabaddi</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
if(isset($_POST['insert1']))
{
 ...
 $insert = "UPDATE `kabaddi` SET `Tname`='$Tname',`P1_id`='$P1_id',`P2_id`='$P2_id',`P3_id`='$P3_id',`P4_id`='$P4_id',`P5_id`='$P5_id', `P6_id`='$P6_id', `P7_id`='$P7_id', `P8_id`='$P8_id', `P9_id`='$P9_id', `P10_id`='$P10_id' WHERE `K_id` ='" . $_GET["id"] . "'";
