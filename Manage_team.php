...
$sql = "SELECT * FROM team ORDER BY T_id DESC ";
        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><a href="edit_team.php?id=<?php echo $rows['T_id']; ?>"><ion-icon name="create-sharp"></ion-icon></a>
                <a href="Delete4.php?id=<?php echo $rows['T_id']; ?>" onclick="return confirm('Want to delete this team??'); "><ion-icon name="trash-sharp"></ion-icon></a></td>
            </tr>
            <?php
                }
             ?>
...
<!-- ./wrapper -->
<a href="Team.php"><button type="button" class="btn btn-block btn-primary btn-lg" style="height:40px;width:150px">Add Team</button></a>
<!-- jQuery -->
