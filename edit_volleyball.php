...
<?php
 ...
 {
 $V_id = $_GET['id'];
 $sql = "SELECT * FROM volleyball WHERE V_id ='" . $_GET["id"] . "'";
...
if(isset($_POST['insert1']))
{
 ...
 $insert = "UPDATE `volleyball` SET `Tname`='$Tname',`P1_id`='$P1_id',`P2_id`='$P2_id',`P3_id`='$P3_id',`P4_id`='$P4_id',`P5_id`='$P5_id', `P6_id`='$P6_id', `P7_id`='$P7_id', `P8_id`='$P8_id' WHERE `V_id` ='" . $_GET["id"] . "'";
