...
$sql = "SELECT * FROM volleyball ORDER BY V_id DESC ";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manage Volleyball Players</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <tr>
                ...
                <td><i class="glyphicon glyphicon-file"></i><a href="edit_volleyball.php?id=<?php echo $rows['V_id']; ?>"><ion-icon name="create-sharp"></ion-icon></a>
                <a href="Delete_volleyball.php?id=<?php echo $rows['V_id']; ?>" onclick="return confirm('Want to delete this team??'); "><ion-icon name="trash-sharp"></ion-icon></a></td>
            </tr>
            <?php
                }
             ?>
...
<!-- ./wrapper -->
<a href="Volleyball.php"><button type="button" class="btn btn-block btn-primary btn-lg" style="height:40px;width:150px">Add Team</button></a>
<!-- jQuery -->
