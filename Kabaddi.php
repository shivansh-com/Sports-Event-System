...
$P1_id = $_POST['P1_id'];
 ...
 $insert = "INSERT INTO `kabaddi`(`Tname`,`P1_id`, `P2_id`, `P3_id`, `P4_id`, `P5_id`, `P6_id`, `P7_id`, `P8_id`, `P9_id`, `P10_id`) VALUES ('$Tname','$P1_id','$P2_id','$P3_id','$P4_id','$P5_id','$P6_id','$P7_id','$P8_id','$P9_id','$P10_id')";
