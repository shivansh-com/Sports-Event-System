...
<?php
 ...
 {
 $T_id = $_GET['id'];
 $sql = "SELECT * FROM team WHERE T_id ='" . $_GET["id"] . "'";
              ...
              <form action="<?php $_PHP_SELF ?>" method="post">
                <div class="card-body">
                   <div class="form-group">
                    <label for="exampleInputT_name1">Team Name</label>
                    <input type="text" class="form-control" name="T_name" id="T_name" value="<?php echo $T_name;?>"placeholder="<?php echo $T_name;?>" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEid1">Email Id</label>
                    <input type="text" class="form-control" name="Eid" id="Eid" value="<?php echo $Eid;?>"placeholder="<?php echo $Eid;?>" required>
                  </div>
...
if(isset($_POST['insert1']))
{
 ...
 $T_name = $_POST['T_name'];
 $Eid = $_POST['Eid'];
 $insert = "UPDATE `team` SET `T_name`='$T_name' ,`Eid`='$Eid' WHERE `T_id` ='" . $_GET["id"] . "'";
